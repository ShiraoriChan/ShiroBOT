      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
            this.reply(m.chat, `Limit kamu Tidak cukup, silahkan beli melalui *${usedPrefix}buy*`, m)
          ...
          for (let user of participants) {
            ...
            try {
              ...
              let wel = await new knights.Welcome()
                ...
                .setAvatar(pp)
                .setBackground("https://telegra.ph/file/7788576b8e14ad52634b3.jpg")
                .toAttachment()
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    owner: 'Perintah ini hanya dapat digunakan oleh _*@6281351047727*_',
